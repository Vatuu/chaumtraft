...
public record ResearchRequirements(
        ...
        List<ResourceLocation> researchRequirements) {
    ...
    public static final Codec<ResearchRequirements> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            ResourceLocation.CODEC.listOf().optionalFieldOf("research", EMPTY.researchRequirements).forGetter(ResearchRequirements::researchRequirements)
    ...
    private static final class Builder {
        ...
        private List<ResourceLocation> craftingRequirements, researchRequirements;
        ...
        public Builder setResearchRequirement(ResourceLocation... research) {
